    ...
    AmqpPubSub.prototype.subscribe = function (trigger, onMessage, options) {
        ...
        if (refs && refs.length > 0) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                var subscriptionConf = typeof trigger === 'object' ? trigger : triggerName;
                _this.consumer.subscribe(subscriptionConf, function (msg) { return _this.onMessage(triggerName, msg); })
